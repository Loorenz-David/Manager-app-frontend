# Frontend Docs Workflow

This folder tracks plan lifecycle state for multi-agent frontend delivery.

## Folder structure

- `architecture/under_construction/`: plans currently being drafted or reviewed.
...
- `handoff/to_backend/`: frontend requests and plans that require backend execution.
- `handoff/from_backend/`: backend outputs and implementation notes for frontend consumption.
...
- `handoff/to_backend/TEMPLATE_HANDOFF_TO_BACKEND.md`
- `handoff/from_backend/TEMPLATE_HANDOFF_FROM_BACKEND.md`
