...
- Name: features/task_creation/task-creation-form-flow.spec.ts >> Task creation staged forms >> return form still advances after selecting an item issue
- Location: tests/playwright/features/task_creation/task-creation-form-flow.spec.ts:82:3
