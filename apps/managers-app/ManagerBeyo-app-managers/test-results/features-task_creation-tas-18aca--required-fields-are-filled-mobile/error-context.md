...
- Name: features/task_creation/task-creation-form-flow.spec.ts >> Task creation staged forms >> return form advances past customer step when all visible required fields are filled
- Location: tests/playwright/features/task_creation/task-creation-form-flow.spec.ts:60:3
