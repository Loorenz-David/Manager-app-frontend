...
export function SlidePageSurface({
  ...
  return (
    <SurfaceHeaderContext.Provider value={{ setTitle, setActions, requestClose: onClose }}>
      ...
      >
        <header className="flex min-h-[56px] flex-shrink-0 items-center gap-3 border-b px-4 py-3">
          <button
            aria-label="Go back"
          ...
          <h1 className="flex-1 truncate text-base font-semibold" id="surface-slide-title">
            {title}
          </h1>
