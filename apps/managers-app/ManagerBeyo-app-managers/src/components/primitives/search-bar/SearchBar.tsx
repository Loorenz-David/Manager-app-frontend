...
export const SearchBar = forwardRef<HTMLInputElement, SearchBarProps>(
  (
    ...
    const showSortButton = typeof onSortPress === "function";
    const showFilterButton = typeof onFilterPress === "function";
    const showActionSeparator = showSortButton || showFilterButton;
