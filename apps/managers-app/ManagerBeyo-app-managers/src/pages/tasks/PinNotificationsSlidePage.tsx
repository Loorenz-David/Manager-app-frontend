...
} from "@/features/tasks/providers/PinNotificationsProvider";
import {
  MANAGER_TASK_PIN_STATES,
  MANAGER_UPHOLSTERY_PIN_STATES,
} from "@/features/tasks/controllers/use-pin-notifications.controller";
      ...
      <ContentCard data-testid="pin-notifications-card">
        <div className="flex flex-col gap-4">
          <div
            ...
            data-testid="pin-notifications-task-card"
          >
            ...
            <BoxPicker
              mode="multiple"
              columns={2}
              options={MANAGER_TASK_PIN_STATES.map((option) => ({
                ...option,
            ...
            >
              ...
              {controller.isUpholsteryPending ? (
                ...
                <BoxPicker
                  mode="multiple"
                  columns={2}
                  options={MANAGER_UPHOLSTERY_PIN_STATES.map((option) => ({
                    ...option,
          ...
          >
            ...
            {/* <p className="text-xs text-muted-foreground">
              {MANAGER_TASK_STEP_PIN_STATES.map((state) => state.label).join(
                ", ",
              )}
            </p> */}
            <PinTaskStepPicker />
