...
export const MANAGER_PRESENTATION_APP_KEY = "manager";

type OpenSurface = (
  id: string,
  props: PresentationSurfaceProps,
) => void;
type CloseSurface = (id: string) => void;

export function isManagerPresentationHome(pathname: string): boolean {
  return pathname === ROUTES.home;
}

export function createManagerPresentationSurfaceOpeners(
  open: OpenSurface,
  close: CloseSurface,
