...
export const SELLER_PRESENTATION_APP_KEY = "seller";

type OpenSurface = (id: string, props: PresentationSurfaceProps) => void;
type CloseSurface = (id: string) => void;

export function isSellerPresentationHome(pathname: string): boolean {
  return pathname === ROUTES.home;
}

export function createSellerPresentationSurfaceOpeners(
  open: OpenSurface,
  close: CloseSurface,
