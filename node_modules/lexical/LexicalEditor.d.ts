...
export interface EditorDOMRenderConfig {
    /** @internal @experimental */
    $createDOM: <T extends LexicalNode>(node: T, editor: LexicalEditor) => HTMLElement;
    /** @internal @experimental */
    $getDOMSlot: <T extends LexicalNode>(node: T, dom: HTMLElement, editor: LexicalEditor) => ElementDOMSlot<HTMLElement>;
    /** @internal @experimental */
    $exportDOM: <T extends LexicalNode>(node: T, editor: LexicalEditor) => DOMExportOutput;
    /** @internal @experimental */
    $extractWithChild: <T extends LexicalNode>(node: T, childNode: LexicalNode, selection: null | BaseSelection, destination: 'clone' | 'html', editor: LexicalEditor) => boolean;
    /** @internal @experimental */
    $decorateDOM: <T extends LexicalNode>(node: T, prevNode: null | T, dom: HTMLElement, editor: LexicalEditor) => void;
    /** @internal @experimental */
    $updateDOM: <T extends LexicalNode>(nextNode: T, prevNode: T, dom: HTMLElement, editor: LexicalEditor) => boolean;
    /** @internal @experimental */
    $shouldInclude: <T extends LexicalNode>(node: T, selection: null | BaseSelection, editor: LexicalEditor) => boolean;
    /** @internal @experimental */
    $shouldExclude: <T extends LexicalNode>(node: T, selection: null | BaseSelection, editor: LexicalEditor) => boolean;
}
 ...
 */
export type RootListener = (rootElement: null | HTMLElement, prevRootElement: null | HTMLElement) => void | (() => void);
...
export type CommandListenerPriorityBefore = typeof COMMAND_PRIORITY_BEFORE_CRITICAL | typeof COMMAND_PRIORITY_BEFORE_EDITOR | typeof COMMAND_PRIORITY_BEFORE_HIGH | typeof COMMAND_PRIORITY_BEFORE_LOW | typeof COMMAND_PRIORITY_BEFORE_NORMAL;
/**
 ...
 */
export declare const COMMAND_PRIORITY_BEFORE_EDITOR = -8;
/**
 ...
 */
export declare const COMMAND_PRIORITY_BEFORE_LOW = -7;
/**
 ...
 */
export declare const COMMAND_PRIORITY_BEFORE_NORMAL = -6;
/**
 ...
 */
export declare const COMMAND_PRIORITY_BEFORE_HIGH = -5;
/**
 ...
 */
export declare const COMMAND_PRIORITY_BEFORE_CRITICAL = -4;
...
type Commands = Map<LexicalCommand<unknown>, Tuple5<DequeSet<AnyCommandListener>>>;
...
export type MapListeners = {
    [K in keyof Listeners as Listeners[K] extends Map<(...args: any[]) => void | undefined | (() => void), undefined | (() => void)> ? K : never]: Listeners[K] extends Map<(...args: infer Args) => void | undefined | (() => void), undefined | (() => void)> ? Args : never;
};
...
/** @internal */
export declare function getTransformSetFromKlass(klass: KlassConstructor<typeof LexicalNode>): Set<Transform<LexicalNode>>;
/** @internal @experimental */
export declare const DEFAULT_EDITOR_DOM_CONFIG: EditorDOMRenderConfig;
/**
...
export declare class LexicalEditor {
     ...
     * @returns a teardown function that can be used to cleanup the listener.
     */
    registerCommand<P>(command: LexicalCommand<P>, listener: CommandListener<P>, priority: CommandListenerPriority | CommandListenerPriorityBefore): () => void;
    /**
