...
const formatState = lexical.createState('format', {
  parse: value => typeof value === 'number' ? value : 0
});
class DecoratorTextNode extends lexical.DecoratorNode {
  $config() {
 ...
 */
const DecoratorTextExtension = lexical.defineExtension({
...
const NestedEditorExtension = lexical.defineExtension({
 ...
 */
const SelectionAlwaysOnDisplayExtension = lexical.defineExtension({
