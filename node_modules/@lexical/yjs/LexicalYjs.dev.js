...
function createCursorSelection(cursor, anchorKey, anchorOffset, focusKey, focusOffset, theme = {}) {
  ...
  if (theme.cursor) {
    ...
    lexical.setDOMStyleObject(caret.style, {
  ...
  if (theme.cursorName) {
    ...
    lexical.setDOMStyleObject(name.style, {
      'background-color': color,
      color: '#fff',
      'font-family': 'Arial',
      'font-size': '12px',
...
function updateCursor(binding, cursor, nextSelection, nodeMap, theme = {}) {
  ...
  for (let i = 0; i < selectionRectsLength; i++) {
    ...
    if (theme.selection) {
      ...
      lexical.setDOMStyleObject(selection.style, {
        ...positionStyle,
        '--lexical-cursor-color': color
      });
      lexical.setDOMStyleObject(selection.firstChild.style, {
        height: '100%',
        left: '0',
        position: 'absolute',
        top: '0',
      ...
      lexical.setDOMStyleObject(selection.style, positionStyle);
      lexical.setDOMStyleObject(selection.firstChild.style, {
        ...positionStyle,
        'background-color': color,
        left: '0',
