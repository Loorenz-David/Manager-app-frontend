...
import { $insertDataTransferForRichText, $handleRichTextDrop, setLexicalClipboardDataTransfer, $getClipboardDataFromSelection, $writeDragSourceToDataTransfer, copyToClipboard } from '@lexical/clipboard';
...
function registerRichText(editor) {
  const removeListener = mergeRegister(editor.registerCommand(CLICK_COMMAND, payload => {
    ...
    if ($isRangeSelection(selection) && !selection.isCollapsed() && event.dataTransfer !== null) {
      ...
      setLexicalClipboardDataTransfer(event.dataTransfer, $getClipboardDataFromSelection(selection));
