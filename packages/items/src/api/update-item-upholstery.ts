...
export type UpdateItemUpholsteryInput = z.infer<
  typeof UpdateItemUpholsteryInputSchema
>;
...
export async function updateItemUpholstery(
  input: UpdateItemUpholsteryInput,
) {
  const { itemUpholsteryId, ...body } =
    UpdateItemUpholsteryInputSchema.parse(input);
