    ...
    >
      <div className="px-6">
        {/*
          ...
          Both opacity and grid-template-rows run off the JS thread — no per-frame JS work.
        */}
        <div
          className={cn(
        ...
        >
          <div className="min-h-0 overflow-hidden">
            {/* Step labels row — labels are shrink-0, separators are flex-1 so › is centered between labels */}
        ...
        {/* Progress bar — margin-top transitions between 0 and 12px (mt-3) */}
        <div
          className={cn(
